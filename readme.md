...
Les mappings déclarés dans la classe KanbanConfiguration permettent d'indiquer au ModelMapper de skip les id des identités lors du passe de l'entité au DTO : en effet, il est inutile de demander à l'utilisateur d'indiquer un id lors de la créatio d'un KanbanBoard, par exemple.
